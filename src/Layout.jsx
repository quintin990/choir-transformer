...
const NAV_ITEMS = [
  ...
  { label: 'Choir',    icon: Users,       page: 'Choir',        activePages: ['Choir', 'ChoirJoin', 'ChoirCreate', 'ChoirPart', 'ChoirSongs', 'ChoirSongDetail', 'ChoirAdmin', 'ChoirAdminSong', 'ChoirSetlists', 'ChoirMemberDashboard', 'ChoirAdminMembers', 'ChoirHub'] },
